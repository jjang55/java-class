...
emp_name carchar2(10) constraint emps_empname_nn not null,
email varchar2(20),
...
insert into emps values(501, null, 'good@gamil.com', 6000, 100);
insert into emps values(501, 'lable', 'musk@gmail.com', 6000, 100);
insert into emps values(501, 'lable', 'good@gmail.com', 6000, 200);
...
manager_id number(6) constraint emp_managerid_fk referencses employees(employee_id),
