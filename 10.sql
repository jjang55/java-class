...
create table emps(
employee_id number(3) primary key, -- primary key = nou null + unique
...
insert into emps values(501, 'lable', 'musk@gmail.com', 6000, 100); -- error (YOU.EMPS_EMAIL_UK) violated
insert into emps values(501, 'lable', 'good@gmail.com', 6000, 200); -- error (YOU.EMPS_DEPTID_FK) violated
...
gu_id number(3) references gu(gu_id) on delete cascade); -- 구에 속한 하위 동이 다 따라 삭제된다
